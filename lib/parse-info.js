...
function parseInfo( data ) {
  ...
  info.transcoder = {
    ...
    videoBitrates: data.transcoderVideoBitrates.split( ',' ).map( toFloat ),
    videoQualities: data.transcoderVideoQualities.split( ',' ).map( toFloat ),
    videoResolutions: data.transcoderVideoResolutions.split( ',' ).map( toFloat ),
  }
